...
static void my_application_activate(GApplication* application) {
  ...
  if (gtk_csd_env != nullptr && g_strcmp0(gtk_csd_env, "0") == 0)
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "Simple Messenger");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "Simple Messenger");
  }
