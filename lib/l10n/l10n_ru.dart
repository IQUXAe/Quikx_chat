...
class L10nRu extends L10n {
  ...
  String get appearOnTopDetails =>
      'Позволяет приложению отображаться сверху (не требуется, если у вас уже настроен QuikxChat как аккаунт для звонков)';
