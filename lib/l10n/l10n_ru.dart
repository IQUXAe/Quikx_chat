...
class L10nRu extends L10n {
  ...
  String get setPermissionsLevelDescription =>
      'Пожалуйста, выберите предопределенную роль ниже или введите пользовательский уровень разрешений от 0 до 100.';

  @override
  String get ignoreUser => 'Игнорировать пользователя';
  ...
  String get commandHint_roomupgrade =>
      'Обновить эту комнату до указанной версии комнаты';
  ...
  String badServerLoginTypesException(
      String serverVersions, String supportedVersions) {
  ...
  @override
  String get checkList => 'Список проверки';
  ...
  String get noGoogleServicesWarning =>
      'Похоже, у вас нет служб Google на вашем телефоне. Это хорошее решение для вашей конфиденциальности! Для получения push-уведомлений в Simple Messenger мы рекомендуем использовать ntfy. С ntfy или другим провайдером единых уведомлений вы можете получать push-уведомления безопасным способом передачи данных. Скачать ntfy можно из F-Droid или из Play Маркета.';
  ...
  String get appearOnTopDetails =>
      'Позволяет приложению отображаться сверху (не требуется, если у вас уже настроен Simple Messenger как аккаунт для звонков)';
  ...
  String get newSpaceDescription =>
      'Пространства ляют объепозводинять Ваши чаты и создавать частные или общедоступные сообщества.';
  ...
  @override
  String get notificationRuleMemberEvent => 'Событие участника';
  ...
  String get notificationRuleIsUserMentionDescription =>
      'Уведомляет пользователя, когда его прямо упоминают в сообщении.';
  ...
  String get notificationRuleContainsDisplayNameDescription =>
      'Уведомляет пользователя, когда сообщение содержит его отображаемое имя.';
  ...
  String get notificationRuleIsRoomMentionDescription =>
      'Уведомляет пользователя при упоминании комнаты.';

  @override
  String get notificationRuleRoomnotif => 'Уведомление комнаты';
  ...
  @override
  String get notificationRuleTombstone => 'Надгробие';

  @override
  String get notificationRuleTombstoneDescription =>
      'Уведомляет пользователя о сообщениях деактивации комнаты.';
  ...
  String get notificationRuleRoomServerAclDescription =>
      'Подавляет уведомления для списков контроля доступа сервера комнаты (ACL).';

  @override
  String get notificationRuleSuppressEdits => 'Подавить правки';
  ...
  String get notificationRuleRoomOneToOneDescription =>
      'Уведомляет пользователя о сообщениях в комнатах один на один.';
  ...
  @override
  String get notificationRuleServerAcl => 'Подавить события Server ACL';

  @override
  String get notificationRuleServerAclDescription =>
      'Подавляет уведомления для событий Server ACL.';
  ...
  String get deletePushRuleCanNotBeUndone =>
      'Если вы удалите эту настройку уведомлений, это нельзя будет отменить.';
  ...
  String get crossVerifiedDevicesIfEnabled =>
      'Перекрестно проверенные устройства, если включено';

  @override
  String get crossVerifiedDevices => 'Перекрестно проверенные устройства';
  ...
  @override
  String get youHaveKnocked => 'Вы постучались';

  @override
  String get pleaseWaitUntilInvited =>
      'Пожалуйста, подождите, пока кто-то из комнаты не пригласит вас.';

  @override
  String get commandHint_logout => 'Выйти с текущего устройства';

  @override
  String get commandHint_logoutall => 'Выйти со всех активных устройств';

  @override
  String get displayNavigationRail => 'Показать панель навигации на мобильном';
  ...
  @override
  String get declineInvitation => 'Отклонить приглашение';

  @override
  String get use24HourTimeFormat => '24-часовой формат времени';

  @override
  String get use24HourTimeFormatDescription =>
      'Показывать время в 24-часовом формате';

  @override
  String get personalEmojis => 'Персональные эмодзи';

  @override
  String get personalEmojisDescription =>
      'Настройка пользовательских эмодзи и стикеров';

  @override
  String get simpleSecureMessaging =>
      'Простое и безопасное приложение для обмена сообщениями на основе протокола Matrix.';

  @override
  String get developerIquxae => 'Разработчик: IQUXAe';

  @override
  String get builtWithFlutter => 'Создано с помощью Flutter и Matrix SDK';
  ...
  String newVersionAvailable(String version) {
    return 'Новая версия $version доступна!';
  }
  ...
  @override
  String get forceUpdate => 'Обязательное обновление';

  @override
  String get forceUpdateMessage =>
      'Требуется обновление для продолжения работы';

  @override
  String get noUpdates => 'Обновлений нет';

  @override
  String latestVersion(String version) {
    return 'Вы используете последнюю версию ($version)';
  }
  ...
  @override
  String get transitionToMatrix => 'Переход на протокол Matrix';

  @override
  String get endToEndEncryptionSupport => 'Поддержка сквозного шифрования';

  @override
  String get improvedUserInterface => 'Улучшенный пользовательский интерфейс';

  @override
  String get bugFixesImprovements => 'Исправления ошибок и улучшения';

  @override
  String get performanceOptimizations => 'Оптимизация производительности';

  @override
  String get initialTestRelease => 'Первоначальный тестовый выпуск';

  @override
  String get basicMessagingFunctionality =>
      'Базовая функциональность обмена сообщениями';

  @override
  String get pushNotificationsBeta => 'Push-уведомления (БЕТА)';

  @override
  String get enhancedSecurityStability =>
      'Улучшенная безопасность и стабильность';

  @override
  String get completeLocalizationSupport => 'Полная поддержка локализации';

  @override
  String get usernameHint => '@имя_пользователя:домен';
  ...
  @override
  String get configurePushNotifications => 'Настроить push-уведомления';

  @override
  String get unifiedPushDescription =>
      'Это приложение использует UnifiedPush для приватных уведомлений. Убедитесь, что у вас установлен дистрибьютор UnifiedPush.';

  @override
  String get pushNotificationPermissionRequired =>
      'Требуется разрешение на уведомления';

  @override
  String get pushNotificationPermissionDescription =>
      'Для получения уведомлений о новых сообщениях необходимо предоставить разрешение на показ уведомлений.';
  ...
  @override
  String get noUnifiedPushDistributor => 'Дистрибьютор UnifiedPush не найден';

  @override
  String get noUnifiedPushDistributorDescription =>
      'Для получения push-уведомлений необходимо установить дистрибьютор UnifiedPush, например ntfy или NextPush.';

  @override
  String get pushNotificationSetupRequired => 'Требуется настройка уведомлений';

  @override
  String get pushNotificationSetupDescription =>
      'Push-уведомления не настроены. Хотите настроить их автоматически?';
  ...
  @override
  String get pushNotificationsEnabledDescription =>
      'Push-уведомления успешно настроены и работают.';

  @override
  String get pushNotificationError => 'Ошибка push-уведомлений';

  @override
  String get pushNotificationErrorDescription =>
      'Произошла ошибка при работе с push-уведомлениями. Попробуйте настроить их заново.';

  @override
  String get configuringPushNotifications => 'Настройка push-уведомлений';

  @override
  String get pleaseWait => 'Пожалуйста, подождите...';

  @override
  String get pushNotificationsConfigured => 'Push-уведомления настроены';

  @override
  String get pushNotificationSetupFailed =>
      'Не удалось настроить push-уведомления';
  ...
  @override
  String get pushNotificationDiagnostics => 'Диагностика push-уведомлений';
  ...
  String get diagnosticsCopied =>
      'Диагностическая информация скопирована в буфер обмена';

  @override
  String get autoSetupPushNotifications =>
      'Автоматическая настройка push-уведомлений';

  @override
  String get manualSetupPushNotifications =>
      'Ручная настройка push-уведомлений';

  @override
  String get testPushNotifications => 'Тестировать уведомления';

  @override
  String get pushNotificationTestSent => 'Тестовое уведомление отправлено';

  @override
  String get pushNotificationStatus => 'Статус push-уведомлений';

  @override
  String get replyToMessage => 'Ответить';

  @override
  String get markAsReadAction => 'Отметить как прочитанное';

  @override
  String get performanceOptimizationAndMemoryLeakFixes =>
      'Оптимизация производительности и исправление утечек памяти';

  @override
  String get improvedUserProfileCaching =>
      'Улучшенное кэширование профилей пользователей';

  @override
  String get centralizedVersionManagement =>
      'Централизованное управление версиями приложения';

  @override
  String get criticalSecurityIssuesFixed =>
  ...
  @override
  String get connectionWorking => 'Соединение работает';

  @override
  String get connectionFailed => 'Соединение не удалось';

  @override
  String get messageTranslation => 'Перевод сообщений';

  @override
  String get messageTranslationDescription =>
      'Перевод между английским и русским языками';
