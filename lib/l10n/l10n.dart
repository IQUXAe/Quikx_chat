...
abstract class L10n {
  ...
  /// No description provided for @use24HourTimeFormat.
  ///
  /// In en, this message translates to:
  /// **'24-hour time format'**
  String get use24HourTimeFormat;

  /// No description provided for @use24HourTimeFormatDescription.
  ///
  /// In en, this message translates to:
  /// **'Display time in 24-hour format'**
  String get use24HourTimeFormatDescription;

  /// No description provided for @personalEmojis.
  ///
  /// In en, this message translates to:
  /// **'Personal emojis'**
  String get personalEmojis;

  /// No description provided for @personalEmojisDescription.
  ///
  /// In en, this message translates to:
  /// **'Configure custom emojis and stickers'**
  String get personalEmojisDescription;

  /// No description provided for @simpleSecureMessaging.
  ///
  /// In en, this message translates to:
  /// **'Simple and secure messaging app based on Matrix protocol.'**
  String get simpleSecureMessaging;

  /// No description provided for @developerIquxae.
  ///
  /// In en, this message translates to:
  /// **'Developer: IQUXAe'**
  String get developerIquxae;

  /// No description provided for @builtWithFlutter.
  ///
  /// In en, this message translates to:
  /// **'Built with Flutter and Matrix SDK'**
  ...
  /// No description provided for @transitionToMatrix.
  ///
  /// In en, this message translates to:
  /// **'Transition to Matrix protocol'**
  String get transitionToMatrix;

  /// No description provided for @endToEndEncryptionSupport.
  ///
  /// In en, this message translates to:
  /// **'End-to-end encryption support'**
  String get endToEndEncryptionSupport;

  /// No description provided for @improvedUserInterface.
  ///
  /// In en, this message translates to:
  /// **'Improved user interface'**
  String get improvedUserInterface;

  /// No description provided for @bugFixesImprovements.
  ///
  /// In en, this message translates to:
  /// **'Bug fixes and improvements'**
  String get bugFixesImprovements;
  ...
  /// No description provided for @initialTestRelease.
  ///
  /// In en, this message translates to:
  /// **'Initial test release'**
  String get initialTestRelease;

  /// No description provided for @basicMessagingFunctionality.
  ///
  /// In en, this message translates to:
  /// **'Basic messaging functionality'**
  String get basicMessagingFunctionality;

  /// No description provided for @pushNotificationsBeta.
  ///
  /// In en, this message translates to:
  /// **'Push notifications (BETA)'**
  String get pushNotificationsBeta;

  /// No description provided for @enhancedSecurityStability.
  ///
  /// In en, this message translates to:
  /// **'Enhanced security and stability'**
  String get enhancedSecurityStability;

  /// No description provided for @completeLocalizationSupport.
  ///
  /// In en, this message translates to:
  /// **'Complete localization support'**
  String get completeLocalizationSupport;
  ...
  /// No description provided for @configurePushNotifications.
  ///
  /// In en, this message translates to:
  /// **'Configure push notifications'**
  String get configurePushNotifications;

  /// No description provided for @unifiedPushDescription.
  ///
  /// In en, this message translates to:
  /// **'This app uses UnifiedPush for privacy-friendly notifications. Make sure you have a UnifiedPush distributor installed.'**
  String get unifiedPushDescription;

  /// No description provided for @pushNotificationPermissionRequired.
  ///
  /// In en, this message translates to:
  /// **'Notification permission required'**
  String get pushNotificationPermissionRequired;

  /// No description provided for @pushNotificationPermissionDescription.
  ///
  /// In en, this message translates to:
  /// **'To receive notifications about new messages, you need to grant notification permission.'**
  ...
  /// No description provided for @noUnifiedPushDistributor.
  ///
  /// In en, this message translates to:
  /// **'No UnifiedPush distributor found'**
  String get noUnifiedPushDistributor;

  /// No description provided for @noUnifiedPushDistributorDescription.
  ///
  /// In en, this message translates to:
  /// **'To receive push notifications, you need to install a UnifiedPush distributor like ntfy or NextPush.'**
  String get noUnifiedPushDistributorDescription;

  /// No description provided for @pushNotificationSetupRequired.
  ///
  /// In en, this message translates to:
  /// **'Push notification setup required'**
  String get pushNotificationSetupRequired;

  /// No description provided for @pushNotificationSetupDescription.
  ///
  /// In en, this message translates to:
  /// **'Push notifications are not configured. Would you like to set them up automatically?'**
  ...
  /// No description provided for @pushNotificationsEnabledDescription.
  ///
  /// In en, this message translates to:
  /// **'Push notifications are successfully configured and working.'**
  String get pushNotificationsEnabledDescription;

  /// No description provided for @pushNotificationError.
  ///
  /// In en, this message translates to:
  /// **'Push notification error'**
  String get pushNotificationError;

  /// No description provided for @pushNotificationErrorDescription.
  ///
  /// In en, this message translates to:
  /// **'An error occurred with push notifications. Try setting them up again.'**
  String get pushNotificationErrorDescription;

  /// No description provided for @configuringPushNotifications.
  ///
  /// In en, this message translates to:
  /// **'Configuring push notifications'**
  String get configuringPushNotifications;
  ...
  /// No description provided for @pushNotificationsConfigured.
  ///
  /// In en, this message translates to:
  /// **'Push notifications configured'**
  String get pushNotificationsConfigured;

  /// No description provided for @pushNotificationSetupFailed.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @pushNotificationDiagnostics.
  ///
  /// In en, this message translates to:
  /// **'Push notification diagnostics'**
  String get pushNotificationDiagnostics;
  ...
  /// No description provided for @autoSetupPushNotifications.
  ///
  /// In en, this message translates to:
  /// **'Auto setup push notifications'**
  String get autoSetupPushNotifications;

  /// No description provided for @manualSetupPushNotifications.
  ///
  /// In en, this message translates to:
  /// **'Manual setup push notifications'**
  ...
  /// No description provided for @pushNotificationTestSent.
  ///
  /// In en, this message translates to:
  /// **'Test notification sent'**
  String get pushNotificationTestSent;

  /// No description provided for @pushNotificationStatus.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @performanceOptimizationAndMemoryLeakFixes.
  ///
  /// In en, this message translates to:
  /// **'Performance optimization and memory leak fixes'**
  String get performanceOptimizationAndMemoryLeakFixes;

  /// No description provided for @improvedUserProfileCaching.
  ///
  /// In en, this message translates to:
  /// **'Improved user profile caching'**
  String get improvedUserProfileCaching;

  /// No description provided for @centralizedVersionManagement.
  ///
  /// In en, this message translates to:
  /// **'Centralized version management'**
  String get centralizedVersionManagement;

  /// No description provided for @criticalSecurityIssuesFixed.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @messageTranslation.
  ///
  /// In en, this message translates to:
  /// **'Message Translation'**
  String get messageTranslation;

  /// No description provided for @messageTranslationDescription.
  ///
  /// In en, this message translates to:
