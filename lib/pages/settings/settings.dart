...
class SettingsController extends State<Settings> {
  ...
  void setDisplaynameAction() async {
    ...
    final success = await showFutureLoadingDialog(
      context: context,
      future: () => matrix.client.setProfileField(matrix.client.userID!, 'displayname', {'displayname': input}),
    );
  ...
  void navigateToStyle() => context.go('/rooms/settings/style');
  void navigateToNotifications() => context.go('/rooms/settings/notifications');
  void navigateToDevices() => context.go('/rooms/settings/devices');
  void navigateToChat() => context.go('/rooms/settings/chat');
  void navigateToSecurity() => context.go('/rooms/settings/security');
  void navigateToHomeserver() => context.go('/rooms/settings/homeserver');
