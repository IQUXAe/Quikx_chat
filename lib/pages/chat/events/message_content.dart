      ...
      case EventTypes.Sticker:
        switch (event.messageType) {
          ...
          case MessageTypes.Audio:
            if (PlatformInfos.supportsAudioPlayback) {
          ...
          default:
            ...
            // Check for translation with notifications
            return ValueListenableBuilder<int>(
              valueListenable: translationNotifier,
              builder: (context, _, __) {
                final translation = messageTranslations[event.eventId];
                
                var html = translation ?? (AppConfig.renderHtml && event.isRichMessage
                    ? event.formattedText
                    : event.body);
                
                if (event.messageType == MessageTypes.Emote && translation == null) {
                  html = '* $html';
                }
