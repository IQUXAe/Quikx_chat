...
class Message extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const roundedCorner = Radius.circular(14.0); // Smaller radius
      ...
      child: Swipeable(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(
            left: 8.0,
            right: 8.0,
            top: nextEventSameSender ? 1.0 : 3.0, // Reduced padding
            bottom: previousEventSameSender ? 1.0 : 3.0, // Reduced padding
          ),
          child: Column(
                                          ...
                                          if (!nextEventSameSender)
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                left: 8.0,
                                                bottom: 1, // Further reduced padding
                                              ),
                                              child: ownMessage ||
                                                      event.room.isDirectChat
                                                  ? const SizedBox(height: 4) // Further reduced height
                                                  : FutureBuilder<User?>(
                                                      future:
...
class _TranslateButton extends StatefulWidget {
  ...
  const _TranslateButton({required this.event, required this.timeline});
...
// Global translation storage (cleared on chat disposal)
Map<String, String> messageTranslations = {};

// Translation change notifications
final ValueNotifier<int> translationNotifier = ValueNotifier(0);

// Function to clear translations
...
// Function to notify about translation changes
