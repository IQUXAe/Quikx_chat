...
bool isInterestingPresence(CachedPresence presence) {
  // Показываем присутствие если:
  // 1. Пользователь онлайн или недоступен
  // 2. У пользователя есть статусное сообщение (независимо от присутствия)
  return !presence.presence.isOffline || (presence.statusMsg?.isNotEmpty ?? false);
}
